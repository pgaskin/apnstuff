// https://cs.android.com/android/platform/superproject/+/android16-qpr2-release:packages/providers/TelephonyProvider/proto/src/carrierId.proto
//
...
var file_carrierId_proto_goTypes = []interface{}{
...
func file_carrierId_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_carrierId_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
		...
		file_carrierId_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
		...
		file_carrierId_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*CarrierAttribute); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
